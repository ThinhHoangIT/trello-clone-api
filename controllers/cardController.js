...
const addMemberChecklistItem = async (req, res) => {
  // Get params
  const user = req.user;
  const { boardId, listId, cardId, checklistId, checklistItemId } = req.params;

  // Call the card service
  await cardService.addMemberInChecklistItem(
    cardId,
    listId,
    boardId,
    user,
...
const deleteMemberChecklistItem = async (req, res) => {
  // Get params
  const user = req.user;
  const { boardId, listId, cardId, checklistId, checklistItemId, memberId } =
    req.params;

  // Call the card service
  await cardService.deleteMemberInChecklistItem(
    cardId,
    listId,
    boardId,
    user,
